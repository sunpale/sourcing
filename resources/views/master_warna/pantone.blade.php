            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table id="tbl-pantone" class="table table-sm table-bordered table-hover dt-responsive nowrap table-striped align-middle w-100 fw">
                        ...
                        <tbody>
                        @foreach($pantone as $pantones)
                            <tr>
                                <td></td>
                                <td></td>
                                <td>{{$pantones->id}}</td>
                                <td class="text-center">{{$pantones->kode}}</td>
                                <td>{{$pantones->pantone}}</td>
                                <td>
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <a href="#" data-bs-toggle="tooltip" data-placement="auto" title="Edit Data" onclick="edit('{{$pantones->id}}')" class="dropdown-item"><i class="ri-edit-fill"></i> Edit Data
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" data-bs-toggle="tooltip" data-placement="auto" title="Hapus Data" class="dropdown-item" onclick="hapus('{{$pantones->id}}')"><i class="ri-close-circle-fill"></i> Hapus Data</a>
                                            </li>
                                        </ul>
                                    </div>
                                </td>
