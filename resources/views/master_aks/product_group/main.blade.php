                                ...
                                <td>
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <a href="#" data-bs-toggle="tooltip" data-placement="auto" title="Edit Data" onclick="edit('{{$group->id}}')" class="dropdown-item"><i class="ri-edit-fill"></i> Edit Data
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" data-bs-toggle="tooltip" data-placement="auto" title="Hapus Data" class="dropdown-item" onclick="hapus('{{$group->id}}')"><i class="ri-close-circle-fill"></i> Hapus Data</a>
                                            </li>
                                        </ul>
                                    </div>
                                </td>
    ...
    <script>
        ...
        function hapus(id){
            ...
            Swal.fire({
                ...
                if(result.value){
                    url_redirect({
                        url     : baseUrl + '/master-aksesoris/product-group/'+id,
                        method  : "post",
        ...
        function edit(id){
            Swal.fire({
                ...
                if(result.value){
                    $.ajax({
                        url         : baseUrl + '/master-aksesoris/product-group/'+id+'/edit',
                        type        : 'get',
                        dataType    : 'json',
                        beforeSend  : function(){
                            FreezeUI();
        ...
        document.addEventListener('DOMContentLoaded',function (){
            ...
            @if(old('number'))
            document.getElementById('frm-group').setAttribute('action','/master-aksesoris/product-group/'+ {{old('number')}});
            let methodEl = document.createElement('input');
            methodEl.type = 'hidden';
            methodEl.name = '_method';
            methodEl.value = 'PATCH';
