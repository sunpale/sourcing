<x-layout breadcrumbs="aksesoris" :datatable="true" :sweetalert="true" :toastify="true" :freeze-ui="true">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    ...
                    <div class="flex-shrink-0">
                        <a href="{!! route('master-material.aksesoris.create') !!}" class="btn btn-sm btn-info waves-effect waves-light">
        ...
        <script>
            function tableAksesoris(){
                const aksesoris = $('#tbl-aksesoris').DataTable({
                    serverSide: true,
                    ajax: '{{route('master-material.aksesoris.data')}}',
                    columns: [
            ...
            function edit(id){
                Swal.fire({
                    ...
                    if(result.value){
                        url_redirect({
                            url : baseUrl + '/master-material/aksesoris/'+id+'/edit',
                            method  : "get"
                        });
                    }
                });
            ...
            function hapus(id){
                ...
                Swal.fire({
                    ...
                    if(result.value){
                        url_redirect({
                            url     : baseUrl + '/master-material/aksesoris/'+id,
                            method  : "post",
            ...
            function view(id){
                window.location.href = baseUrl + '/master-material/aksesoris/'+id
            }
