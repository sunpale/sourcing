<x-layout breadcrumbs="bom.create" :select2="true" :jsvalidation="true" :glightbox="true">
    ...
    @section('script')
        {!! JsValidator::formRequest('App\Http\Requests\BOM\BomRequest') !!}
        <script>
            ...
            function getMaterials(row,section){
                ...
                $('#'+section+'-item'+row).select2({
                    ajax : {
                        url         : '{{route('master-material.raw-material.data-materials')}}',
                        dataType    : 'json',
                        type        : 'get',
                        delay       : 250,
                        data        : function (params) {
            ...
            function getImagePrice(row,section){
                let url = section==='body' ? baseUrl + '/master-material/raw-material/image-url/' : baseUrl + '/master-material/aksesoris/image-url/';
