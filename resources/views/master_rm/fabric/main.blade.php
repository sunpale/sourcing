    ...
    <script>
        ...
        function hapus(id){
            ...
            Swal.fire({
                ...
                if(result.value){
                    url_redirect({
                        url     : baseUrl + '/master-rm/fabric/'+id,
                        method  : "post",
        ...
        function edit(id){
            Swal.fire({
                ...
                if(result.value){
                    $.ajax({
                        url         : baseUrl + '/master-rm/fabric/'+id+'/edit',
                        type        : 'get',
                        dataType    : 'json',
                        beforeSend  : function(){
                            FreezeUI();
                        ...
                        success     : function (response) {
                            ...
                            document.getElementById('frm-fabric').setAttribute('action','/master-rm/fabric/'+id);
            ...
            prefix.oninput = function (){
                ...
                if (this.value === document.getElementById('old_kode').value.substring(0,1)){
                    ...
                    $.ajax({
                        ...
                        dataType    : 'json',
                        success     : function (response) {
                            document.getElementById('kode').value = response.generatedCode;
                            description.value = '';
                            description.focus();
                        }
                    });
