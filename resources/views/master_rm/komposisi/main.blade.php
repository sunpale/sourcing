    ...
    <script>
        ...
        function hapus(id){
            ...
            Swal.fire({
                ...
                if(result.value){
                    url_redirect({
                        url     : baseUrl + '/master-rm/komposisi/'+id,
                        method  : "post",
        ...
        function edit(id){
            Swal.fire({
                ...
                if(result.value){
                    $.ajax({
                        url         : baseUrl + '/master-rm/komposisi/'+id+'/edit',
                        type        : 'get',
                        dataType    : 'json',
                        beforeSend  : function(){
                            FreezeUI();
                        ...
                        success     : function (response) {
                            ...
                            document.getElementById('frm-komposisi').setAttribute('action','/master-rm/komposisi/'+id);
        ...
        document.addEventListener('DOMContentLoaded',function (){
            ...
            @if(old('number'))
            document.getElementById('frm-komposisi').setAttribute('action','/master-rm/komposisi/'+{{old('number')}});
            let methodEl = document.createElement('input');
            methodEl.type = 'hidden';
            methodEl.name = '_method';
            methodEl.value = 'PATCH';
